...
ct=0
sheet2=wbb.add_sheet('MA - DP1')
sheet3=wbb.add_sheet('MA Feat Imp - DP1')
sheet2.write(0, 0, 'Mode')
sheet2.write(1, 0, 'Unperturbed')
#sheet2.write(0, 1, 'Parameter')
...
for _ in range(100):
  ...
  puma_1_df=dp_counts_df(puma_1_df,eps)
...
pumas=list(df1['PUMA'].unique())
ct=0
sheet2=wbb.add_sheet('MA - DP2')
sheet3=wbb.add_sheet('MA Feat Imp - DP2')
sheet2.write(0, 0, 'Mode')
sheet2.write(1, 0, 'Unperturbed')
#sheet2.write(0, 1, 'Parameter')
sheet2.write(0, 2, 'Accuracy')
...
pumas=list(df1['PUMA'].unique())
ct=0
sheet2=wbb.add_sheet('TX - DP1')
sheet3=wbb.add_sheet('TX Feat Imp - DP1')
sheet2.write(0, 0, 'Mode')
sheet2.write(1, 0, 'Unperturbed')
#sheet2.write(0, 1, 'Parameter')
sheet2.write(0, 2, 'Accuracy')
...
pumas=list(df1['PUMA'].unique())
ct=0
sheet2=wbb.add_sheet('TX - DP2')
sheet3=wbb.add_sheet('TX Feat Imp - DP2')
sheet2.write(0, 0, 'Mode')
sheet2.write(1, 0, 'Unperturbed')
#sheet2.write(0, 1, 'Parameter')
sheet2.write(0, 2, 'Accuracy')
...
pumas=list(df1['PUMA'].unique())
ct=0
sheet2=wbb.add_sheet('Outlier - DP1')
sheet3=wbb.add_sheet('Outlier Feat Imp - DP1')
sheet2.write(0, 0, 'Mode')
sheet2.write(1, 0, 'Unperturbed')
#sheet2.write(0, 1, 'Parameter')
sheet2.write(0, 2, 'Accuracy')
...
pumas=list(df1['PUMA'].unique())
ct=0
sheet2=wbb.add_sheet('Outlier - DP2')
sheet3=wbb.add_sheet('Outlier Feat Imp - DP2')
sheet2.write(0, 0, 'Mode')
sheet2.write(1, 0, 'Unperturbed')
#sheet2.write(0, 1, 'Parameter')
sheet2.write(0, 2, 'Accuracy')
