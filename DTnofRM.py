...
ct=0
sheet2=wbb.add_sheet('MA - RM6')
sheet3=wbb.add_sheet('MA Feat Imp - RM6')
...
pumas=list(df1['PUMA'].unique())
ct=0
sheet2=wbb.add_sheet('MA - RM10')
sheet3=wbb.add_sheet('MA Feat Imp - RM10')
sheet2.write(0, 0, 'Mode')
sheet2.write(1, 0, 'Unperturbed')
#sheet2.write(0, 1, 'Parameter')
sheet2.write(0, 2, 'Accuracy')
...
pumas=list(df1['PUMA'].unique())
ct=0
sheet2=wbb.add_sheet('TX - RM6')
sheet3=wbb.add_sheet('TX Feat Imp - RM6')
sheet2.write(0, 0, 'Mode')
sheet2.write(1, 0, 'Unperturbed')
#sheet2.write(0, 1, 'Parameter')
sheet2.write(0, 2, 'Accuracy')
...
pumas=list(df1['PUMA'].unique())
ct=0
sheet2=wbb.add_sheet('TX - RM10')
sheet3=wbb.add_sheet('TX Feat Imp - RM10')
sheet2.write(0, 0, 'Mode')
sheet2.write(1, 0, 'Unperturbed')
#sheet2.write(0, 1, 'Parameter')
sheet2.write(0, 2, 'Accuracy')
...
pumas=list(df1['PUMA'].unique())
ct=0
sheet2=wbb.add_sheet('Outlier - RM6')
sheet3=wbb.add_sheet('Outlier Feat Imp - RM6')
sheet2.write(0, 0, 'Mode')
sheet2.write(1, 0, 'Unperturbed')
#sheet2.write(0, 1, 'Parameter')
sheet2.write(0, 2, 'Accuracy')
...
pumas=list(df1['PUMA'].unique())
ct=0
sheet2=wbb.add_sheet('Outlier - RM10')
sheet3=wbb.add_sheet('Outlier Feat Imp - RM10')
sheet2.write(0, 0, 'Mode')
sheet2.write(1, 0, 'Unperturbed')
#sheet2.write(0, 1, 'Parameter')
sheet2.write(0, 2, 'Accuracy')
