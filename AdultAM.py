...
for fname in fnames:
  l1errsredact2, fairerrsredact2=adjmerge_errs2(hist1,fnames,3)
  l1errsredact3, fairerrsredact3=adjmerge_errs2(hist1,fnames,6)
  l1errsredact6, fairerrsredact6=adjmerge_errs2(hist1,fnames,10)
  ...
  plt.title('AM - Adult - l1 - '+str(fname))
  plt.xlabel('k')
  plt.ylabel('l1 Errors')
  plt.savefig('AdultAM_L1_'+str(fname)+'.pdf',format='pdf',dpi=300)
  sns.boxplot(data=pd.DataFrame({'3':fairerrsredact2, '6':fairerrsredact3, '10':fairerrsredact6}))
  plt.title('AM - Adult - fair - '+str(fname))
  plt.xlabel('k')
  plt.ylabel('Fairness Errors')
  plt.savefig('AdultAM_Fair_'+str(fname)+'.pdf',format='pdf',dpi=300)
