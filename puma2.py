...
def perpumaanalysis():
  ...
  for df_name in df_names:
    df=pd.read_csv(df_name)
'''
df=pd.read_csv('ma_acs_2019.csv')
pumas=list(df['PUMA'].unique())
...
plt.savefig('4DP_L1_'+str(puma)+'.pdf',format='pdf',dpi=300)
plt.clf()
...
plt.savefig('4DP_Fair_'+str(puma)+'.pdf',format='pdf',dpi=300)
plt.clf()
#fnameses=[['AGE','RACE'],['RACE','SEX'],['RACE','OWNERSHP'],['SEX','OWNERSHP']]
#fnames=['AGE','OWNERSHP']
for fnames in fnameses:
...
plt.savefig('4RM_L1_'+str(puma)+'.pdf',format='pdf',dpi=300)
plt.clf()
...
plt.savefig('4RM_Fair_'+str(puma)+'.pdf',format='pdf',dpi=300)
plt.clf()
#perdbanalysis()
perpumaanalysis()
