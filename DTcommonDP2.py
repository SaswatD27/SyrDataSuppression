...
pumas=list(df1['PUMA'].unique())
ct=0
sheet2=wbb.add_sheet('MA - DP 1')
sheet3=wbb.add_sheet('MA Feat Imp - DP 1')
sheet2.write(0, 0, 'PUMAs')
sheet2.write(0, 1, 'Race')
sheet2.write(0, 2, 'Accuracy')
sheet2.write(0, 3, 'Height of Tree')
...
pumas=list(df1['PUMA'].unique())
ct=0
sheet2=wbb.add_sheet('MA - DP 2')
sheet3=wbb.add_sheet('MA Feat Imp - DP 2')
sheet2.write(0, 0, 'PUMAs')
sheet2.write(0, 1, 'Race')
sheet2.write(0, 2, 'Accuracy')
sheet2.write(0, 3, 'Height of Tree')
...
pumas=list(df1['PUMA'].unique())
ct=0
sheet2=wbb.add_sheet('Outlier - DP 1')
sheet3=wbb.add_sheet('Outlier Feat Imp - DP 1')
sheet2.write(0, 0, 'PUMAs')
sheet2.write(0, 1, 'Race')
sheet2.write(0, 2, 'Accuracy')
sheet2.write(0, 3, 'Height of Tree')
...
pumas=list(df1['PUMA'].unique())
ct=0
sheet2=wbb.add_sheet('Outlier - DP 2')
sheet3=wbb.add_sheet('Outlier Feat Imp - DP 2')
sheet2.write(0, 0, 'PUMAs')
sheet2.write(0, 1, 'Race')
sheet2.write(0, 2, 'Accuracy')
sheet2.write(0, 3, 'Height of Tree')
